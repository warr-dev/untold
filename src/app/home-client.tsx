...
export default function HomeClient() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground bg-mesh-glow relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 w-full max-w-3xl pt-10 border-t border-zinc-200/50 dark:border-white/5">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                ...
                <span className="text-xs text-zinc-404 dark:text-zinc-404 mt-1">{stat.desc}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Philosophy Section */}
      <section id="philosophy" className="py-20 bg-zinc-55 dark:bg-black/20 border-y border-zinc-200/50 dark:border-white/5">
      ...
      <section id="guidelines" className="py-20 bg-zinc-55 dark:bg-black/20 border-t border-zinc-200/50 dark:border-white/5">
