      ...
      <header className="sticky top-0 z-45 w-full border-b border-zinc-200/50 dark:border-white/5 bg-background/80 backdrop-blur-md transition-colors h-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <h1 className="hidden sm:inline-block px-2.5 py-0.5 rounded bg-zinc-200 text-zinc-700 dark:bg-white/5 dark:text-zinc-400 text-[10px] font-bold uppercase tracking-wider">
              Sharing Hub
            </h1>
          </div>
                    ...
                    <div className="py-4 space-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex gap-2 items-center">
                          <div className="flex-1 py-1.5 px-2.5 rounded-lg bg-zinc-50 dark:bg-zinc-900/50 dark:border-zinc-800 text-[10px] font-mono text-zinc-700 dark:text-zinc-300 break-all select-all text-left">
                            {myAuthorId}
                          </div>
                          <button
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className={`w-full py-2.5 px-4 rounded-xl text-xs font-bold transition-all duration-300 text-left flex items-center justify-between cursor-pointer ${
                  feedType === "following"
                    ? "bg-brand-indigo text-white shadow-md shadow-brand-indigo/15 scale-102"
                    : "bg-zinc-100 hover:bg-zinc-200 text-zinc-550 dark:bg-white/5 dark:text-zinc-400 dark:hover:bg-white/10"
                }`}
              >
          ...
          <div className="glass-panel p-5 rounded-2xl w-full border border-zinc-200/60 dark:border-white/5">
            ...
            <div className="relative mb-3">
              <input
                ...
                className="w-full px-3 py-1.5 text-[11px] rounded-lg border border-zinc-200 bg-zinc-50 dark:bg-zinc-900/50 dark:border-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-brand-indigo"
              />
              {tagSearchQuery && (
                <button
                  type="button"
                  onClick={() => setTagSearchQuery("")}
                  className="absolute right-2.5 top-2.5 text-[10px] text-zinc-400 hover:text-zinc-855 dark:text-zinc-500 dark:hover:text-zinc-200"
                >
                  ✕
                </button>
              )}
            ...
            <nav className="flex flex-row lg:flex-col gap-1.5 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-none max-h-60 lg:max-h-72 overflow-y-auto pr-1">
              ...
              {filteredTagsList.length === 0 && (
                <p className="text-[10px] italic text-zinc-400 dark:text-zinc-500 py-2">
                  No tags found
                </p>
              )}
            </nav>
        ...
        <section className="flex-1 w-full min-h-[500px]">
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-32">
              ...
              <p className="text-xs text-zinc-400 mt-4 font-medium animate-pulse">Loading stories...</p>
            </div>
